							...
							<span class="jqzoom">
								<#if (imageList?size > 0)>
									<img jqimg="${imageList[0].url}"
										 src="${imageList[0].url}" width="400px" height="400px"/>
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationList as s>
								<dl>
									...
									<#list s.attributeValue as option>
									    <#-- class="selected" -->
										<dd><a href="javascript:;"
											   class="{{isSelected('${s.attributeName}','${option}') ? 'selected' : ''}}"
											   ng-click="selectSpec('${s.attributeName}','${option}');">${option}
